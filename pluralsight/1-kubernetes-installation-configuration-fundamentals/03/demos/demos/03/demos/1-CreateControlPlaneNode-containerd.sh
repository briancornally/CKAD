...
sed -i "s/  advertiseAddress: 1.2.3.4/  advertiseAddress: $ip4/" ClusterConfiguration.yaml
grep advertiseAddress ClusterConfiguration.yaml
...
grep -i version ~/ClusterConfiguration.yaml
