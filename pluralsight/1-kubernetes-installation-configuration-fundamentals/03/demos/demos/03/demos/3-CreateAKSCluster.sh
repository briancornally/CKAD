...
az group create --name "Kubernetes-Cloud" --location SoutheastAsia
...
kubectl debug node/aks-nodepool1-17560005-vmss000000 -it --image=mcr.microsoft.com/aks/fundamental/base-ubuntu:v0.0.11

kubectl debug node/aks-nodepool1-17560005-vmss000000 --image=mcr.microsoft.com/aks/fundamental/base-ubuntu:v0.0.11

kubectl get pods

kubectl exec -it node-debugger-aks-nodepool1-17560005-vmss000000-7phql -- sh 
