...
gcloud projects create bc-psdemogke-1 --name="Kubernetes-Cloud"


#Set our current project context
gcloud config set project bc-psdemogke-1
...
#   https://cloud.google.com/kubernetes-engine/docs/how-to/api-server-authentication#authenticating_users
gcloud container clusters get-credentials cscluster --zone us-central1-a --project bc-psdemogke-1
...
kubectl config use-context gke_bc-psdemogke-1_us-central1-a_cscluster
...
#Delete our project.
gcloud projects delete bc-psdemogke-1
...
gcloud projects delete long-base-167913