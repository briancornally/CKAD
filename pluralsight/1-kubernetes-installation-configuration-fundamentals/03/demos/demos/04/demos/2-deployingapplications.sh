...
SERVCIEIP=10.111.95.248 # local
SERVCIEIP=10.96.141.57
SERVCIEIP=10.111.219.24
PORT=80
#Access the Service inside the cluster
echo curl http://$SERVCIEIP:$PORT
curl http://$SERVCIEIP:$PORT
curl http://10.111.219.24:80
curl http://10.3.252.71:80
...
ENDPOINT=10.1.0.65
ENDPOINT=192.168.222.193
TARGETORT=8080
curl http://$ENDPOINT:$TARGETORT
curl http://192.168.222.193:8080
...
kubectl get service hello-world
SERVICEIP=10.101.97.165
SERVICEIP=10.0.183.179
